		...
		<u-popup :blur="blur" :maskCloseAble="maskCloseAble" mode="bottom" :popup="false" v-model="popupValue"
			...
			<view class="u-select">
				...
				<view class="u-select__body">
					 ...
					 <diy-tree v-model="selectData" @select="treeSelect" @change="changeTreeSelect" :selectParent="selectParent" :checkStrictly="checkStrictly" :mode="mode" :list="ulist" :foldAll="flod" :valueName="valueName" :labelName="labelName"></diy-tree>
					 </scroll-view>
				</view>
			</view>
		</u-popup>
