<template>
	...
	<view class="container">
		<image src="https://cdn.pic.in.th/file/picinth/banner-bg.d26093a6.png" class="response diygw-col-24" mode="widthFix"></image>
		<view class="flex diygw-col-24">
			<diy-noticebar class="flex1 diy-notice-bar" color="#07c160" bgColor="#fff" leftIcon="diy-icon-notification">
				<!-- #ifndef VUE3 -->
				<block slot="content">
					<text class="diy-notice-item">ยินดีต้อนรับเข้าสู่ GM-TH แพลตฟอร์มสร้างรายได้ออนไลน์</text>
				</block>
				<!-- #endif -->
				<!-- #ifdef VUE3 -->
				<block v-slot:content>
					<text class="diy-notice-item"> ยินดีต้อนรับเข้าสู่ GM-TH แพลตฟอร์มสร้างรายได้ออนไลน </text>
				</block>
				<!-- #endif -->
			</diy-noticebar>
		</view>
		<view class="flex diygw-col-24 audio-clz">
			<diy-audio class="flex-sub" author="DIYGW可视化音频组件" music="http://cdn.diygw.com/1.mp3" avatar-type="icon" title="♪" icon="diy-icon-musicfill" background-clazz="green" size-clz="" active-color="#F266AB" is-silder is-title autoplay poster="/static/grid7.png"></diy-audio>
		</view>
		<view class="flex diygw-col-24">
			<view class="diygw-list">
				<view @tap="navigateTo" data-type="page" data-url="/pages/grid" style="" class="diygw-item col-50 flex-direction-row-reverse solid-bottom diygw-card diygw-shadow list-item-clz bg-mauve">
					...
					<view class="content">
						<view class="title"> จิ่วกงเกอ </view>
